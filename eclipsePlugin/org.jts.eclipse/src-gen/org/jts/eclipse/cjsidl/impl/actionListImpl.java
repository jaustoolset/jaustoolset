 ...
 * <ul>
 *   <li>{@link org.jts.eclipse.cjsidl.impl.actionListImpl#getActions <em>Actions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class actionListImpl extends MinimalEObjectImpl.Container implements actionList
{
  ...
  {
    return CjsidlPackage.eINSTANCE.getactionList();
  }
  ...
  public EList<action> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectContainmentEList<action>(action.class, this, CjsidlPackage.ACTION_LIST__ACTIONS);
    }
    return actions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CjsidlPackage.ACTION_LIST__ACTIONS:
