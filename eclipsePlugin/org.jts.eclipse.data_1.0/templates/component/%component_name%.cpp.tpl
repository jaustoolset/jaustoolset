...
using namespace JTS;
%service_namespace_list%

%component_name%::%component_name%(unsigned int subsystem, unsigned short node, unsigned short component)
{
...
void %component_name%::startComponent()
{
	Service* service;
...
void %component_name%::shutdownComponent()
{
	Service* service;
...
void %component_name%::processInternalEvent(InternalEvent *ie)
{
    bool done = false;
