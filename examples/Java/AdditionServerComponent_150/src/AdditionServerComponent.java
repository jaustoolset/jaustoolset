...
import src.urn_jaus_example_addition_server_1_0.AdditionServerServiceDefService;



class AdditionServerComponent extends EventReceiver
    {
	protected ArrayList<Service> serviceList = new ArrayList<Service>();
	JausRouter jausRouter;

	AdditionServerComponent(int subsystem, short node, short component)
    {
