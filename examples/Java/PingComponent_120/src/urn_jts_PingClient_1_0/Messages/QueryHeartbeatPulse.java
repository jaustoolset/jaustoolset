package src.urn_jts_PingClient_1_0.Messages;
...
public class QueryHeartbeatPulse extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x2202;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public QueryHeartbeatPulse.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public QueryHeartbeatPulse.AppHeader assign(AppHeader value)
		{
	...
	public boolean isEqual(QueryHeartbeatPulse value)
	{
	...
	public boolean notEquals(QueryHeartbeatPulse value)
	{
