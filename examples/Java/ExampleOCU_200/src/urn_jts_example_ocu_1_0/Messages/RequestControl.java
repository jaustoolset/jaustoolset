...
public class RequestControl extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x000d;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public RequestControl.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public RequestControl.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public RequestControl.AppHeader assign(AppHeader value)
		{
	...
	{
		public static class  RequestControlRec
		{
			...
			public RequestControl.Body.RequestControlRec assign(RequestControlRec value)
			{
			...
			public boolean isEqual(RequestControlRec value)
			{
			...
			public boolean notEquals(RequestControlRec value)
			{
				return !this.isEqual(value);
			}
			
			public RequestControlRec()
			{
				m_parent = null;
				m_AuthorityCode = 0;
			}
			
			public RequestControlRec(RequestControlRec value)
			{
				/// Initiliaze the protected variables
				m_parent = null;
				m_AuthorityCode = 0;
		...
		protected RequestControlRec m_RequestControlRec;
	
		public RequestControl.Body.RequestControlRec getRequestControlRec()
		{
			return m_RequestControlRec;
		}
		
		public void setRequestControlRec(RequestControlRec value)
		{
		...
		public RequestControl.Body assign(Body value)
		{
		...
		{
			if (!m_RequestControlRec.isEqual(value.getRequestControlRec()))
			{
				return false;
			}
			/// This code is currently not supported
		...
		public Body()
		{
			m_RequestControlRec = new RequestControlRec();
			m_RequestControlRec.setParent(this);
		}
	...
	public RequestControl.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public RequestControl.Body getBody()
	{
		return m_Body;
	}
	...
	public boolean isEqual(RequestControl value)
	{
	...
	public boolean notEquals(RequestControl value)
	{
