...
public class ConfirmElementRequest extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x041c;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public ConfirmElementRequest.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ConfirmElementRequest.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ConfirmElementRequest.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  RequestIDRec
		{
			...
			public ConfirmElementRequest.Body.RequestIDRec assign(RequestIDRec value)
			{
		...
		public ConfirmElementRequest.Body.RequestIDRec getRequestIDRec()
		{
		...
		public ConfirmElementRequest.Body assign(Body value)
		{
	...
	public ConfirmElementRequest.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public ConfirmElementRequest.Body getBody()
	{
		return m_Body;
	}
	...
	public ConfirmElementRequest setAs(ConfirmElementRequest value)
	{
	...
	public boolean isEqual(ConfirmElementRequest value)
	{
	...
	public boolean notEquals(ConfirmElementRequest value)
	{
		return !isEqual(value);
	}
	
	public ConfirmElementRequest()
	{
	...
	public  ConfirmElementRequest(ConfirmElementRequest value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
