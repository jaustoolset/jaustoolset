...
public class SetLocalWaypoint extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x040d;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetLocalWaypoint.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetLocalWaypoint.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetLocalWaypoint.AppHeader assign(AppHeader value)
		{
	...
	public static class  Body
	{
		public static class  LocalWaypointRec
		{
			...
			public SetLocalWaypoint.Body.LocalWaypointRec assign(LocalWaypointRec value)
			{
		...
		public SetLocalWaypoint.Body.LocalWaypointRec getLocalWaypointRec()
		{
		...
		public SetLocalWaypoint.Body assign(Body value)
		{
	...
	public SetLocalWaypoint.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetLocalWaypoint.Body getBody()
	{
		return m_Body;
	}
	...
	public SetLocalWaypoint setAs(SetLocalWaypoint value)
	{
	...
	public boolean isEqual(SetLocalWaypoint value)
	{
	...
	public boolean notEquals(SetLocalWaypoint value)
	{
		return !isEqual(value);
	}
	
	public SetLocalWaypoint()
	{
	...
	public  SetLocalWaypoint(SetLocalWaypoint value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
