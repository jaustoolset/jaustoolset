...
public class SetEmergency extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0006;
	...
	public static class  MsgHeader
	{
		public static class  HeaderRec
		{
			...
			public SetEmergency.MsgHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetEmergency.MsgHeader assign(MsgHeader value)
		{
	...
	{
		public static class  SetEmergencyRec
		{
			...
			public SetEmergency.Body.SetEmergencyRec assign(SetEmergencyRec value)
			{
			...
			public boolean isEqual(SetEmergencyRec value)
			{
			...
			public boolean notEquals(SetEmergencyRec value)
			{
				return !this.isEqual(value);
				}
		...
		protected SetEmergencyRec m_SetEmergencyRec;
		...
		public SetEmergency.Body assign(Body value)
		{
		...
		{
			if (!m_SetEmergencyRec.isEqual(value.getSetEmergencyRec()))
			{
				return false;
			}
			/// This code is currently not supported
	...
	public boolean isEqual(SetEmergency value)
	{
	...
	public boolean notEquals(SetEmergency value)
	{
