...
import src.urn_jts_example_management_ocu_1_0.ManagementOCUService;



class ManagementOCU extends EventReceiver
    {
	protected ArrayList<Service> serviceList = new ArrayList<Service>();
	JausRouter jausRouter;

	ManagementOCU(int subsystem, short node, short component)
    {
