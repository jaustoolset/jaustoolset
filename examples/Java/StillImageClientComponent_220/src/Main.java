...
public class Main {
	private static Logger logger = Logger.getLogger("StillImageClientComponent_log");
	...
	public static void main(String[] args)
	{
		try
		{
	    	...
	    	StillImageClientComponent cmpt = new StillImageClientComponent(126, (short) 1, (short) 220);
