...
public class SetStillImageSensorConfiguration extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0807;
	...
	public static class  AppHeader
	{
		public static class  HeaderRec
		{
			...
			public SetStillImageSensorConfiguration.AppHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public SetStillImageSensorConfiguration.AppHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public SetStillImageSensorConfiguration.AppHeader assign(AppHeader value)
		{
	...
	{
		public static class  StillImageSensorConfigurationSequence
		{
			public static class  RequestIdRec
			{
			
				protected StillImageSensorConfigurationSequence m_parent;
				protected short m_RequestID;
			
				public void setParent(StillImageSensorConfigurationSequence parent)
				{
					m_parent = parent;
				}
				...
				public SetStillImageSensorConfiguration.Body.StillImageSensorConfigurationSequence.RequestIdRec assign(RequestIdRec value)
				{
			...
			public static class  StillImageSensorList
			{
				public static class  StillImageSensorConfigurationRec
				{
					...
					public SetStillImageSensorConfiguration.Body.StillImageSensorConfigurationSequence.StillImageSensorList.StillImageSensorConfigurationRec assign(StillImageSensorConfigurationRec value)
					{
				...
				public SetStillImageSensorConfiguration.Body.StillImageSensorConfigurationSequence.StillImageSensorList.StillImageSensorConfigurationRec getElement(int index)
				{
				...
				public SetStillImageSensorConfiguration.Body.StillImageSensorConfigurationSequence.StillImageSensorList assign(StillImageSensorList value)
				{
			...
			public SetStillImageSensorConfiguration.Body.StillImageSensorConfigurationSequence.RequestIdRec getRequestIdRec()
			{
			...
			public SetStillImageSensorConfiguration.Body.StillImageSensorConfigurationSequence.StillImageSensorList getStillImageSensorList()
			{
			...
			public SetStillImageSensorConfiguration.Body.StillImageSensorConfigurationSequence assign(StillImageSensorConfigurationSequence value)
			{
			...
			public boolean isEqual(StillImageSensorConfigurationSequence value)
			{
				...
				if (!m_StillImageSensorList.isEqual(value.getStillImageSensorList()))
				{
					return false;
				}
			...
			public boolean notEquals(StillImageSensorConfigurationSequence value)
			{
				return !this.isEqual(value);
			}
			
			public StillImageSensorConfigurationSequence()
			{
				m_parent = null;
			...
			public StillImageSensorConfigurationSequence(StillImageSensorConfigurationSequence value)
			{
				/// Initiliaze the protected variables
				m_parent = null;
				m_RequestIdRec = new RequestIdRec();
		...
		protected StillImageSensorConfigurationSequence m_StillImageSensorConfigurationSequence;
	
		public SetStillImageSensorConfiguration.Body.StillImageSensorConfigurationSequence getStillImageSensorConfigurationSequence()
		{
			return m_StillImageSensorConfigurationSequence;
		}
		
		public int setStillImageSensorConfigurationSequence(StillImageSensorConfigurationSequence value)
		{
		...
		public SetStillImageSensorConfiguration.Body assign(Body value)
		{
		...
		{
			if (!m_StillImageSensorConfigurationSequence.isEqual(value.getStillImageSensorConfigurationSequence()))
			{
				return false;
			}
			/// This code is currently not supported
		...
		public Body()
		{
			m_StillImageSensorConfigurationSequence = new StillImageSensorConfigurationSequence();
			m_StillImageSensorConfigurationSequence.setParent(this);
		}
	...
	public SetStillImageSensorConfiguration.AppHeader getAppHeader()
	{
		return m_AppHeader;
	}
	...
	public SetStillImageSensorConfiguration.Body getBody()
	{
		return m_Body;
	}
	...
	public SetStillImageSensorConfiguration setAs(SetStillImageSensorConfiguration value)
	{
	...
	public boolean isEqual(SetStillImageSensorConfiguration value)
	{
	...
	public boolean notEquals(SetStillImageSensorConfiguration value)
	{
		return !isEqual(value);
	}
	
	public SetStillImageSensorConfiguration()
	{
	...
	public  SetStillImageSensorConfiguration(SetStillImageSensorConfiguration value)
	{
		/// Initiliaze the protected variables
		m_AppHeader = new AppHeader();
		m_Body = new Body();
