...
import src.urn_jaus_example_addition_client_1_0.AdditionClientServiceDefService;



class AdditionClientComponent extends EventReceiver
    {
	protected ArrayList<Service> serviceList = new ArrayList<Service>();
	JausRouter jausRouter;

	AdditionClientComponent(int subsystem, short node, short component)
    {
