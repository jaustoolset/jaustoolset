...
public class Main {
	private static Logger logger = Logger.getLogger("AdditionClientComponent_log");
	...
	public static void main(String[] args)
	{
		try
		{
	    	...
	    	AdditionClientComponent cmpt = new AdditionClientComponent(126, (short) 1, (short) 151);
