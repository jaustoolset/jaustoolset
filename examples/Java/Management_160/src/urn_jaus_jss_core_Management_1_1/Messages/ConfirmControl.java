...
public class ConfirmControl extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x000f;
	...
	public static class  MsgHeader
	{
		public static class  HeaderRec
		{
			...
			public ConfirmControl.MsgHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ConfirmControl.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ConfirmControl.MsgHeader assign(MsgHeader value)
		{
	...
	{
		public static class  ConfirmControlRec
		{
			...
			public ConfirmControl.Body.ConfirmControlRec assign(ConfirmControlRec value)
			{
			...
			public boolean isEqual(ConfirmControlRec value)
			{
			...
			public boolean notEquals(ConfirmControlRec value)
			{
				return !this.isEqual(value);
				}
				
			public ConfirmControlRec()
			{
				m_parent = null;
				m_ResponseCode = 0;
			}
		...
		protected ConfirmControlRec m_ConfirmControlRec;
	
		public ConfirmControl.Body.ConfirmControlRec getConfirmControlRec()
		{
		...
		public ConfirmControl.Body assign(Body value)
		{
		...
		{
			if (!m_ConfirmControlRec.isEqual(value.getConfirmControlRec()))
			{
				return false;
			}
			/// This code is currently not supported
	...
	public ConfirmControl.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public ConfirmControl.Body getBody()
	{
		return m_Body;
	}
	...
	public boolean isEqual(ConfirmControl value)
	{
	...
	public boolean notEquals(ConfirmControl value)
	{
