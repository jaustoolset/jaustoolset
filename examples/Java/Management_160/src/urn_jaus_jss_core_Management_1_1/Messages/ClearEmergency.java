...
public class ClearEmergency extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x0007;
	...
	public static class  MsgHeader
	{
		public static class  HeaderRec
		{
			...
			public ClearEmergency.MsgHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ClearEmergency.MsgHeader assign(MsgHeader value)
		{
	...
	{
		public static class  ClearEmergencyRec
		{
		
			protected Body m_parent;
			protected int m_EmergencyCode;
			...
			public void setEmergencyCode(int value)
			{
				if ((value == 1))
				{
			...
			public void encode(ByteBuffer bytes, int pos)
			{
				...
				bytes.putShort(pos, (short) m_EmergencyCode);
				pos += JausUtils.getNumBytes("short");
			}
			...
			public void decode(ByteBuffer bytes, int pos)
			{
				...
				m_EmergencyCode = bytes.getShort(pos) & 0xffff;
				pos += JausUtils.getNumBytes("short");
			}
			
			public ClearEmergency.Body.ClearEmergencyRec assign(ClearEmergencyRec value)
			{
			...
			public boolean isEqual(ClearEmergencyRec value)
			{
				if (m_EmergencyCode != value.getEmergencyCode())
				{
					return false;
				}
			...
			public boolean notEquals(ClearEmergencyRec value)
			{
				return !this.isEqual(value);
				}
		...
		protected ClearEmergencyRec m_ClearEmergencyRec;
		...
		public ClearEmergency.Body assign(Body value)
		{
		...
		{
			if (!m_ClearEmergencyRec.isEqual(value.getClearEmergencyRec()))
			{
				return false;
			}
			/// This code is currently not supported
	...
	public boolean isEqual(ClearEmergency value)
	{
	...
	public boolean notEquals(ClearEmergency value)
	{
