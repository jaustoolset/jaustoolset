...
public class ReportAuthority extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4001;
	...
	public static class  MsgHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportAuthority.MsgHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportAuthority.MsgHeader assign(MsgHeader value)
		{
	...
	{
		public static class  ReportAuthorityRec
		{
			...
			public ReportAuthority.Body.ReportAuthorityRec assign(ReportAuthorityRec value)
			{
			...
			public boolean isEqual(ReportAuthorityRec value)
			{
			...
			public boolean notEquals(ReportAuthorityRec value)
			{
				return !this.isEqual(value);
			}
		...
		protected ReportAuthorityRec m_ReportAuthorityRec;
		...
		public ReportAuthority.Body assign(Body value)
		{
		...
		{
			if (!m_ReportAuthorityRec.isEqual(value.getReportAuthorityRec()))
			{
				return false;
			}
			/// This code is currently not supported
	...
	public boolean isEqual(ReportAuthority value)
	{
	...
	public boolean notEquals(ReportAuthority value)
	{
