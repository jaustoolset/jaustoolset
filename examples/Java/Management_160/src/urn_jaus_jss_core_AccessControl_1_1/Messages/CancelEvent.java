...
public class CancelEvent extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x01f2;
	...
	public static class  MsgHeader
	{
		public static class  HeaderRec
		{
			...
			public CancelEvent.MsgHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public CancelEvent.MsgHeader assign(MsgHeader value)
		{
	...
	{
		public static class  CancelEventRec
		{
			...
			public CancelEvent.Body.CancelEventRec assign(CancelEventRec value)
			{
			...
			public boolean isEqual(CancelEventRec value)
			{
			...
			public boolean notEquals(CancelEventRec value)
			{
				return !this.isEqual(value);
			}
		...
		protected CancelEventRec m_CancelEventRec;
		...
		public CancelEvent.Body assign(Body value)
		{
		...
		{
			if (!m_CancelEventRec.isEqual(value.getCancelEventRec()))
			{
				return false;
			}
			/// This code is currently not supported
	...
	public boolean isEqual(CancelEvent value)
	{
	...
	public boolean notEquals(CancelEvent value)
	{
