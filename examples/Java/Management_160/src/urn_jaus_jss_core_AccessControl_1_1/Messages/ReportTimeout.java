...
public class ReportTimeout extends Message
{
	protected static Logger logger = Logger.getLogger("framework.logger");
	public static int ID = 0x4003;
	...
	public static class  MsgHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportTimeout.MsgHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportTimeout.MsgHeader assign(MsgHeader value)
		{
	...
	public static class  Body
	{
		public static class  ReportTimoutRec
		{
			...
			public ReportTimeout.Body.ReportTimoutRec assign(ReportTimoutRec value)
			{
		...
		public ReportTimeout.Body assign(Body value)
		{
	...
	public boolean isEqual(ReportTimeout value)
	{
	...
	public boolean notEquals(ReportTimeout value)
	{
