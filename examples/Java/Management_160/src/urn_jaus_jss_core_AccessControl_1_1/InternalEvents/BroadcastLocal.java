package src.urn_jaus_jss_core_AccessControl_1_1.InternalEvents;
...
public class BroadcastLocal extends InternalEvent
{
	...
	public static class  Body
	{
		public static class  BroadcastRec
		{
			public static class  DestinationID
			{
				...
				public BroadcastLocal.Body.BroadcastRec.DestinationID assign(DestinationID value)
				{
			...
			public static class  SourceID
			{
				...
				public BroadcastLocal.Body.BroadcastRec.SourceID assign(SourceID value)
				{
					this.m_SubFields = value.m_SubFields;
			...
			public static class  MessagePayload
			{
				...
				public BroadcastLocal.Body.BroadcastRec.MessagePayload assign(MessagePayload value)
				{
			...
			public BroadcastLocal.Body.BroadcastRec assign(BroadcastRec value)
			{
		...
		public BroadcastLocal.Body assign(Body value)
		{
	...
	public boolean isEqual(BroadcastLocal value)
	{
	...
	public boolean notEquals(BroadcastLocal value)
	{
