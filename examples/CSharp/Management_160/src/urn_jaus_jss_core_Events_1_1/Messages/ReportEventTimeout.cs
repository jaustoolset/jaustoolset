...
public class ReportEventTimeout : JTS.Message
{
	protected ushort ID = 0x41f2;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public ReportEventTimeout.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public ReportEventTimeout.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public class Body
	{
		public class ReportTimoutRec
		{
			...
			public ReportEventTimeout.Body.ReportTimoutRec  setReportTimoutRec(ReportTimoutRec value)
			{
		...
		public ReportEventTimeout.Body  setBody(Body value)
		{
	...
	public bool  isEqual(ReportEventTimeout value)
	{
	...
	public bool  notEquals(ReportEventTimeout value)
	{
		return !this.isEqual(value);
	}
