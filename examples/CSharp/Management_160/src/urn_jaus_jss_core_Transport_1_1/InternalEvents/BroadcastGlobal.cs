...
public class BroadcastGlobal : InternalEvent
{
	public class Body
	{
		public class BroadcastRec
		{
			...
			public class MessagePayload
			{
				...
				public BroadcastGlobal.Body.BroadcastRec.MessagePayload  setMessagePayload(MessagePayload value)
				{
		...
		public BroadcastGlobal.Body  setBody(Body value)
		{
