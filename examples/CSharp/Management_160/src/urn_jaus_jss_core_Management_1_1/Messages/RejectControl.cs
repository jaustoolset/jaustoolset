...
public class RejectControl : JTS.Message
{
	protected ushort ID = 0x0010;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public RejectControl.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public RejectControl.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public RejectControl.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public class Body
	{
		public class RejectControlRec
		{
			...
			public RejectControl.Body.RejectControlRec  setRejectControlRec(RejectControlRec value)
			{
			...
			public bool isEqual(RejectControlRec value)
			{
			...
			public bool notEquals(RejectControlRec value)
			{
				return !this.isEqual(value);
				}
				
			public RejectControlRec()
			{
				m_parent = null;
				m_ResponseCode = 0;
			}
			
			public RejectControlRec(RejectControlRec value)
			{
				/// Initiliaze the protected variables
				m_parent = null;
				m_ResponseCode = 0;
		...
		public RejectControl.Body.RejectControlRec getRejectControlRec()
		{
			return m_RejectControlRec;
		}
		
		public void setRejectControlRec(RejectControlRec value)
		{
		...
		public RejectControl.Body  setBody(Body value)
		{
			m_RejectControlRec = value.getRejectControlRec();
		...
		{
			if (!this.getRejectControlRec().isEqual(value.getRejectControlRec()))
			{
				return false;
			}
			/// This code is currently not supported
		...
		public Body()
		{
			m_RejectControlRec = new RejectControlRec();
			m_RejectControlRec.setParent(this);
		}
		...
		protected RejectControlRec m_RejectControlRec = new  RejectControlRec();
	}
	...
	public RejectControl.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public RejectControl.Body getBody()
	{
		return m_Body;
	}
	...
	public RejectControl setAs(RejectControl value)
	{
	...
	public bool  isEqual(RejectControl value)
	{
	...
	public bool  notEquals(RejectControl value)
	{
		return !this.isEqual(value);
		}
