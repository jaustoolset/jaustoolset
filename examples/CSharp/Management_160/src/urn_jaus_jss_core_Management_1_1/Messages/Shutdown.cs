...
public class Shutdown : JTS.Message
{
	protected ushort ID = 0x0002;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public Shutdown.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public Shutdown.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public Shutdown.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public Shutdown.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public Shutdown setAs(Shutdown value)
	{
	...
	public bool  isEqual(Shutdown value)
	{
	...
	public bool  notEquals(Shutdown value)
	{
		return !this.isEqual(value);
		}
	...
	public  Shutdown(Shutdown value)
	{
		/// Initiliaze the protected variables
		m_MsgHeader = new MsgHeader();
		m_IsCommand = true;
