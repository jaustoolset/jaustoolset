...
public class QueryStatus : JTS.Message
{
	protected ushort ID = 0x2002;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public QueryStatus.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public QueryStatus.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public QueryStatus.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public QueryStatus.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public QueryStatus setAs(QueryStatus value)
	{
	...
	public bool  isEqual(QueryStatus value)
	{
	...
	public bool  notEquals(QueryStatus value)
	{
		return !this.isEqual(value);
		}
	...
	public  QueryStatus(QueryStatus value)
	{
		/// Initiliaze the protected variables
		m_MsgHeader = new MsgHeader();
		m_IsCommand = false;
