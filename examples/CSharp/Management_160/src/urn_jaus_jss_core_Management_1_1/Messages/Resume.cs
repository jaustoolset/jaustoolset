...
public class Resume : JTS.Message
{
	protected ushort ID = 0x0004;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public Resume.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public Resume.MsgHeader  setMsgHeader(MsgHeader value)
		{
