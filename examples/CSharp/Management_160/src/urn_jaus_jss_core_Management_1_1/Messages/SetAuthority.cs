...
public class SetAuthority : JTS.Message
{
	protected ushort ID = 0x0001;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public SetAuthority.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
	...
	public class Body
	{
		...
		{
			if (!this.getAuthorityRec().isEqual(value.getAuthorityRec()))
			{
				return false;
			}
			/// This code is currently not supported
		...
		protected authorityRec m_AuthorityRec = new  authorityRec();
	}
	...
	public bool  isEqual(SetAuthority value)
	{
	...
	public bool  notEquals(SetAuthority value)
	{
		return !this.isEqual(value);
		}
