...
public class Reset : JTS.Message
{
	protected ushort ID = 0x0005;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public Reset.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public Reset.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public Reset.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public Reset.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public Reset setAs(Reset value)
	{
	...
	public bool  isEqual(Reset value)
	{
	...
	public bool  notEquals(Reset value)
	{
		return !this.isEqual(value);
		}
