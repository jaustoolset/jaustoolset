...
public class QueryAuthority : JTS.Message
{
	protected ushort ID = 0x2001;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public QueryAuthority.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public QueryAuthority.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public QueryAuthority.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public QueryAuthority.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public QueryAuthority setAs(QueryAuthority value)
	{
	...
	public bool  isEqual(QueryAuthority value)
	{
	...
	public bool  notEquals(QueryAuthority value)
	{
		return !this.isEqual(value);
		}
	...
	public  QueryAuthority(QueryAuthority value)
	{
		/// Initiliaze the protected variables
		m_MsgHeader = new MsgHeader();
		m_IsCommand = false;
