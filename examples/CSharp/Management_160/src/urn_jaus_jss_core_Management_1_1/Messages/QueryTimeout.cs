...
public class QueryTimeout : JTS.Message
{
	protected ushort ID = 0x2003;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public QueryTimeout.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public QueryTimeout.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public QueryTimeout.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public QueryTimeout.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public QueryTimeout setAs(QueryTimeout value)
	{
	...
	public bool  isEqual(QueryTimeout value)
	{
	...
	public bool  notEquals(QueryTimeout value)
	{
		return !this.isEqual(value);
		}
