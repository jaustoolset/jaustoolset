...
public class ReleaseControl : JTS.Message
{
	protected ushort ID = 0x000e;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public ReleaseControl.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public ReleaseControl.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReleaseControl.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public ReleaseControl.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public ReleaseControl setAs(ReleaseControl value)
	{
	...
	public bool  isEqual(ReleaseControl value)
	{
	...
	public bool  notEquals(ReleaseControl value)
	{
		return !this.isEqual(value);
	}
	...
	public  ReleaseControl(ReleaseControl value)
	{
		/// Initiliaze the protected variables
		m_MsgHeader = new MsgHeader();
		m_IsCommand = true;
