...
public class QueryControl : JTS.Message
{
	protected ushort ID = 0x200d;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public QueryControl.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public QueryControl.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public QueryControl.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public QueryControl.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public QueryControl setAs(QueryControl value)
	{
	...
	public bool  isEqual(QueryControl value)
	{
	...
	public bool  notEquals(QueryControl value)
	{
		return !this.isEqual(value);
	}
	...
	public  QueryControl(QueryControl value)
	{
		/// Initiliaze the protected variables
		m_MsgHeader = new MsgHeader();
		m_IsCommand = false;
