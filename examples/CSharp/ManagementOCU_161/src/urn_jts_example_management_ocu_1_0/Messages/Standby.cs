...
public class Standby : JTS.Message
{
	protected ushort ID = 0x0003;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public Standby.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public Standby.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public Standby.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public Standby.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public Standby setAs(Standby value)
	{
	...
	public bool  isEqual(Standby value)
	{
	...
	public bool  notEquals(Standby value)
	{
		return !this.isEqual(value);
		}
