#include "urn_jaus_jss_environmentSensing_StillImage_1_0/Messages/ConfirmEventRequest.h"

namespace urn_jaus_jss_environmentSensing_StillImage_1_0
{

void ConfirmEventRequest::AppHeader::HeaderRec::setParent(AppHeader* parent)
{
	m_parent = parent;
}

void ConfirmEventRequest::AppHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger ConfirmEventRequest::AppHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int ConfirmEventRequest::AppHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int ConfirmEventRequest::AppHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void ConfirmEventRequest::AppHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void ConfirmEventRequest::AppHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
ConfirmEventRequest::AppHeader::HeaderRec &ConfirmEventRequest::AppHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool ConfirmEventRequest::AppHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
ConfirmEventRequest::AppHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x01f3;
}

ConfirmEventRequest::AppHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
ConfirmEventRequest::AppHeader::HeaderRec* const ConfirmEventRequest::AppHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int ConfirmEventRequest::AppHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void ConfirmEventRequest::AppHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int ConfirmEventRequest::AppHeader::getSize()
{
	unsigned int size = 0;
...
void ConfirmEventRequest::AppHeader::encode(unsigned char *bytes)
{
...
void ConfirmEventRequest::AppHeader::decode(const unsigned char *bytes)
{
...
ConfirmEventRequest::AppHeader &ConfirmEventRequest::AppHeader::operator=(const AppHeader &value)
{
...
bool ConfirmEventRequest::AppHeader::operator==(const AppHeader &value) const
{
...
ConfirmEventRequest::AppHeader::AppHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

ConfirmEventRequest::AppHeader::AppHeader(const AppHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
ConfirmEventRequest::AppHeader* const ConfirmEventRequest::getAppHeader()
{
	return &m_AppHeader;
}

int ConfirmEventRequest::setAppHeader(const AppHeader &value)
{
	m_AppHeader = value;
	return 0;
}
