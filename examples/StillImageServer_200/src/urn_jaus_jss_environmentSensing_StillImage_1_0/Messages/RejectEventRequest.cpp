#include "urn_jaus_jss_environmentSensing_StillImage_1_0/Messages/RejectEventRequest.h"

namespace urn_jaus_jss_environmentSensing_StillImage_1_0
{

void RejectEventRequest::AppHeader::HeaderRec::setParent(AppHeader* parent)
{
	m_parent = parent;
}

void RejectEventRequest::AppHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger RejectEventRequest::AppHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int RejectEventRequest::AppHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int RejectEventRequest::AppHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void RejectEventRequest::AppHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void RejectEventRequest::AppHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
RejectEventRequest::AppHeader::HeaderRec &RejectEventRequest::AppHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool RejectEventRequest::AppHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
RejectEventRequest::AppHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x01f4;
}

RejectEventRequest::AppHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
RejectEventRequest::AppHeader::HeaderRec* const RejectEventRequest::AppHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int RejectEventRequest::AppHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void RejectEventRequest::AppHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int RejectEventRequest::AppHeader::getSize()
{
	unsigned int size = 0;
...
void RejectEventRequest::AppHeader::encode(unsigned char *bytes)
{
...
void RejectEventRequest::AppHeader::decode(const unsigned char *bytes)
{
...
RejectEventRequest::AppHeader &RejectEventRequest::AppHeader::operator=(const AppHeader &value)
{
...
bool RejectEventRequest::AppHeader::operator==(const AppHeader &value) const
{
...
RejectEventRequest::AppHeader::AppHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

RejectEventRequest::AppHeader::AppHeader(const AppHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
RejectEventRequest::AppHeader* const RejectEventRequest::getAppHeader()
{
	return &m_AppHeader;
}

int RejectEventRequest::setAppHeader(const AppHeader &value)
{
	m_AppHeader = value;
	return 0;
}
