#include "urn_jaus_jss_core_AccessControl_1_1/Messages/ReportControl.h"

namespace urn_jaus_jss_core_AccessControl_1_1
{

void ReportControl::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void ReportControl::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger ReportControl::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int ReportControl::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int ReportControl::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void ReportControl::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void ReportControl::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
ReportControl::MsgHeader::HeaderRec &ReportControl::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool ReportControl::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
ReportControl::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x400d;
}

ReportControl::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
ReportControl::MsgHeader::HeaderRec* const ReportControl::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int ReportControl::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void ReportControl::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int ReportControl::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void ReportControl::MsgHeader::encode(unsigned char *bytes)
{
...
void ReportControl::MsgHeader::decode(const unsigned char *bytes)
{
...
ReportControl::MsgHeader &ReportControl::MsgHeader::operator=(const MsgHeader &value)
{
...
bool ReportControl::MsgHeader::operator==(const MsgHeader &value) const
{
...
ReportControl::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

ReportControl::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
ReportControl::MsgHeader* const ReportControl::getMsgHeader()
{
	return &m_MsgHeader;
}

int ReportControl::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
