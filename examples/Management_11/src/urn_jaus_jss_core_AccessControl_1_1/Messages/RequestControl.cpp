#include "urn_jaus_jss_core_AccessControl_1_1/Messages/RequestControl.h"

namespace urn_jaus_jss_core_AccessControl_1_1
{

void RequestControl::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void RequestControl::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger RequestControl::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int RequestControl::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int RequestControl::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void RequestControl::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void RequestControl::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
RequestControl::MsgHeader::HeaderRec &RequestControl::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool RequestControl::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
RequestControl::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x000d;
}

RequestControl::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
RequestControl::MsgHeader::HeaderRec* const RequestControl::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int RequestControl::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void RequestControl::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int RequestControl::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void RequestControl::MsgHeader::encode(unsigned char *bytes)
{
...
void RequestControl::MsgHeader::decode(const unsigned char *bytes)
{
...
RequestControl::MsgHeader &RequestControl::MsgHeader::operator=(const MsgHeader &value)
{
...
bool RequestControl::MsgHeader::operator==(const MsgHeader &value) const
{
...
RequestControl::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

RequestControl::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
RequestControl::MsgHeader* const RequestControl::getMsgHeader()
{
	return &m_MsgHeader;
}

int RequestControl::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
