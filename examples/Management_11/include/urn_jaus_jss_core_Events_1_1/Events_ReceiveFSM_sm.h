...
namespace urn_jaus_jss_core_Events_1_1
{
    ...
    public:
        ...
        virtual void CreateEvntTransition(Events_ReceiveFSMContext& context);
        ...
        virtual void ReceiveTransition(Events_ReceiveFSMContext& context, CreateEvnt msg, Receive::Body::ReceiveRec transportData);
    ...
    public:
        ...
        void ReceiveTransition(Events_ReceiveFSMContext& context, CreateEvnt msg, Receive::Body::ReceiveRec transportData);
    ...
    public:
        ...
        void CreateEvntTransition(Events_ReceiveFSMContext& context);
        void EventErrorTransition(Events_ReceiveFSMContext& context);
        void EventOccurredTransition(Events_ReceiveFSMContext& context);
    ...
    public:
        ...
        void ReceiveTransition(CreateEvnt msg, Receive::Body::ReceiveRec transportData)
        {
            setTransition("ReceiveTransition");
            (getState()).ReceiveTransition(*this, msg, transportData);
            setTransition(NULL);
