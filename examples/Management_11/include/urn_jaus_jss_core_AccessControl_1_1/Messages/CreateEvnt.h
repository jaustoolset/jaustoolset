#ifndef URN_JAUS_JSS_CORE_ACCESSCONTROL_1_1_CREATEEVNT_H
#define URN_JAUS_JSS_CORE_ACCESSCONTROL_1_1_CREATEEVNT_H
...
class DllExport CreateEvnt: public JTS::Message
{
public:
	...
	virtual void encode(unsigned char *bytes);
	virtual void decode(const unsigned char *bytes);
	CreateEvnt &operator=(const CreateEvnt &value);
	bool operator==(const CreateEvnt &value) const;
	bool operator!=(const CreateEvnt &value) const;
	CreateEvnt();
	CreateEvnt(const CreateEvnt &value);
	virtual ~CreateEvnt();
...
#endif // URN_JAUS_JSS_CORE_ACCESSCONTROL_1_1_CREATEEVNT_H
