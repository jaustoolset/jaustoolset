...
namespace urn_jaus_jss_core_Management_1_1
{
    ...
    public:
        ...
        virtual void CommandCompletedTransition(Management_SendFSMContext& context);
        virtual void CommandExpiredTransition(Management_SendFSMContext& context);
        virtual void CreateCommandEventTransition(Management_SendFSMContext& context);
        virtual void CreateEvntTransition(Management_SendFSMContext& context);
        ...
        virtual void QueryEventTimeoutTransition(Management_SendFSMContext& context);
    ...
    public:
        ...
        void CommandCompletedTransition(Management_SendFSMContext& context);
        void CommandExpiredTransition(Management_SendFSMContext& context);
        void CreateCommandEventTransition(Management_SendFSMContext& context);
        void CreateEvntTransition(Management_SendFSMContext& context);
        ...
        void QueryEventTimeoutTransition(Management_SendFSMContext& context);
