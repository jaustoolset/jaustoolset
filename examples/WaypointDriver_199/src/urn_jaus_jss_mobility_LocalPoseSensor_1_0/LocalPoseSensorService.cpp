...
bool LocalPoseSensorService::processTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if (ie->getName().compare("InternalStateChange_To_LocalPoseSensor_ReceiveFSM_Receiving_Ready_Controlled") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("Receive") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("InternalStateChange_To_LocalPoseSensor_ReceiveFSM_Receiving_Ready_NotControlled") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("InternalStateChange_To_LocalPoseSensor_ReceiveFSM_Receiving_Ready") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("InternalStateChange_To_LocalPoseSensor_ReceiveFSM_Receiving") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
...
bool LocalPoseSensorService::defaultTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if (ie->getName().compare("Timeout") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("EventOccurred") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("EventError") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("Send") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("BroadcastLocal") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("BroadcastGlobal") == 0 && (ie->getSource().compare("LocalPoseSensor_ReceiveFSM") != 0) && (done == false))
				{
			...
			try
			{
				if (ie->getName().compare("Receive") == 0 && (ie->getSource().compare("LocalPoseSensor_SendFSM") != 0) && (done == false))
				{
					Receive* casted_ie = (Receive*) ie;
					unsigned short id = *((unsigned short*) casted_ie->getBody()->getReceiveRec()->getMessagePayload()->getData());
					if ( id == SetLocalPose::ID)
			...
			try
			{
				if (ie->getName().compare("Timeout") == 0 && (ie->getSource().compare("LocalPoseSensor_SendFSM") != 0) && (done == false))
				{
					Timeout* casted_ie = (Timeout*) ie;
			...
			try
			{
				if (ie->getName().compare("EventOccurred") == 0 && (ie->getSource().compare("LocalPoseSensor_SendFSM") != 0) && (done == false))
				{
					EventOccurred* casted_ie = (EventOccurred*) ie;
			...
			try
			{
				if (ie->getName().compare("EventError") == 0 && (ie->getSource().compare("LocalPoseSensor_SendFSM") != 0) && (done == false))
				{
					EventError* casted_ie = (EventError*) ie;
			...
			try
			{
				if (ie->getName().compare("Send") == 0 && (ie->getSource().compare("LocalPoseSensor_SendFSM") != 0) && (done == false))
				{
					Send* casted_ie = (Send*) ie;
			...
			try
			{
				if (ie->getName().compare("BroadcastLocal") == 0 && (ie->getSource().compare("LocalPoseSensor_SendFSM") != 0) && (done == false))
				{
					BroadcastLocal* casted_ie = (BroadcastLocal*) ie;
			...
			try
			{
				if (ie->getName().compare("BroadcastGlobal") == 0 && (ie->getSource().compare("LocalPoseSensor_SendFSM") != 0) && (done == false))
				{
					BroadcastGlobal* casted_ie = (BroadcastGlobal*) ie;
