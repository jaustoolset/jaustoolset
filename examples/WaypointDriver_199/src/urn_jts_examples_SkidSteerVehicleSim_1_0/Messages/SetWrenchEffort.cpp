...
void SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::setParent(JAUSApplicationLayerHeader* parent)
{
	m_parent = parent;
}

void SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec &SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x0405;
}

SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
SetWrenchEffort::JAUSApplicationLayerHeader::HeaderRec* const SetWrenchEffort::JAUSApplicationLayerHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int SetWrenchEffort::JAUSApplicationLayerHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void SetWrenchEffort::JAUSApplicationLayerHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int SetWrenchEffort::JAUSApplicationLayerHeader::getSize()
{
	unsigned int size = 0;
...
void SetWrenchEffort::JAUSApplicationLayerHeader::encode(unsigned char *bytes)
{
...
void SetWrenchEffort::JAUSApplicationLayerHeader::decode(const unsigned char *bytes)
{
...
SetWrenchEffort::JAUSApplicationLayerHeader &SetWrenchEffort::JAUSApplicationLayerHeader::operator=(const JAUSApplicationLayerHeader &value)
{
...
bool SetWrenchEffort::JAUSApplicationLayerHeader::operator==(const JAUSApplicationLayerHeader &value) const
{
...
SetWrenchEffort::JAUSApplicationLayerHeader::JAUSApplicationLayerHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

SetWrenchEffort::JAUSApplicationLayerHeader::JAUSApplicationLayerHeader(const JAUSApplicationLayerHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
SetWrenchEffort::JAUSApplicationLayerHeader* const SetWrenchEffort::getJAUSApplicationLayerHeader()
{
	return &m_JAUSApplicationLayerHeader;
}

int SetWrenchEffort::setJAUSApplicationLayerHeader(const JAUSApplicationLayerHeader &value)
{
