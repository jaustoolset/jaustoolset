...
public class TransportService extends Service{
	...
	public synchronized boolean processTransitions(InternalEvent ie)
	{
		...
		// Invoke the FSM transition for this event.
			try
			{
				if ((done == false) && ie.getName().compareTo("Send") == 0 && (ie.getSource().compareTo("Transport_SendFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastLocal") == 0 && (ie.getSource().compareTo("Transport_SendFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastGlobal") == 0 && (ie.getSource().compareTo("Transport_SendFSM") != 0))
				{
	...
	public synchronized boolean defaultTransitions(InternalEvent ie)
	{
		...
		// Invoke the FSM transition for this event.
			try
			{
				if ((done == false) && ie.getName().compareTo("Send") == 0 && (ie.getSource().compareTo("Transport_ReceiveFSM") != 0))
				{
					Send casted_ie = (Send) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastLocal") == 0 && (ie.getSource().compareTo("Transport_ReceiveFSM") != 0))
				{
					BroadcastLocal casted_ie = (BroadcastLocal) ie;
			...
			try
			{
				if ((done == false) && ie.getName().compareTo("BroadcastGlobal") == 0 && (ie.getSource().compareTo("Transport_ReceiveFSM") != 0))
				{
					BroadcastGlobal casted_ie = (BroadcastGlobal) ie;
