 ...
 * from file : Transport_ReceiveFSMContext.sm
 */
...
//
    ...
    //
        ...
        // Constants.
        //
        public static final Transport_ReceiveFSM_SM_Receiving Receiving =
            new Transport_ReceiveFSM_SM_Receiving("Transport_ReceiveFSM_SM.Receiving", 0);
        public static final Transport_ReceiveFSM_SM_Internally_Generated_State_DO_NOT_USE Internally_Generated_State_DO_NOT_USE =
            new Transport_ReceiveFSM_SM_Internally_Generated_State_DO_NOT_USE("Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE", 1);
    ...
    //
        ...
        protected void ReceiveTransition(Transport_ReceiveFSMContext context)
        {
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("LEAVING STATE   : Transport_ReceiveFSM_SM.Receiving");
            }
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("ENTER TRANSITION: Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Receiving.ReceiveTransition()");
            }
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("EXIT TRANSITION : Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Receiving.ReceiveTransition()");
            }
    ...
    //
        ...
        protected void BroadcastGlobalTransition(Transport_ReceiveFSMContext context)
        {
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("LEAVING STATE   : Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE");
            }
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("ENTER TRANSITION: Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastGlobalTransition()");
            }
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("EXIT TRANSITION : Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastGlobalTransition()");
            }
        ...
        protected void BroadcastLocalTransition(Transport_ReceiveFSMContext context)
        {
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("ENTER TRANSITION: Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastLocalTransition()");
            }
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("EXIT TRANSITION : Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastLocalTransition()");
            }
        ...
        protected void ReceiveTransition(Transport_ReceiveFSMContext context)
        {
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("ENTER TRANSITION: Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.ReceiveTransition()");
            }
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("EXIT TRANSITION : Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.ReceiveTransition()");
            }
        ...
        protected void SendTransition(Transport_ReceiveFSMContext context)
        {
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("ENTER TRANSITION: Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.SendTransition()");
            }
            ...
            if (context.getDebugFlag() == true)
            {
                ...
                str.println("EXIT TRANSITION : Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.SendTransition()");
            }
