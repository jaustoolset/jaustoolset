...
public class ReportIdentification extends Message
{
	...
	public static class  MsgHeader
	{
		public static class  HeaderRec
		{
			...
			public ReportIdentification.MsgHeader.HeaderRec assign(HeaderRec value)
			{
		...
		public ReportIdentification.MsgHeader assign(MsgHeader value)
		{
	...
	public static class  Body
	{
		public static class  ReportIdentificationRec
		{
			...
			{
				if (((value >= 5) && (value <= 255)) || (value == 3) || (value == 4) || (value == 0) || (value == 1) || (value == 2))
				{
					m_QueryType = value;
					setParentPresenceVector();
				}
