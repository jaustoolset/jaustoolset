...
bool EventsService::processTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if ((done == false) && ie->getName().compare("Timeout") == 0 && (ie->getSource().compare("Events_ReceiveFSM") != 0))
				{
...
bool EventsService::defaultTransitions(InternalEvent* ie)
{
   ...
   mutex.lock();
			...
			try
			{
				if ((done == false) && ie->getName().compare("CommandCompleted") == 0 && (ie->getSource().compare("Events_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("CommandExpired") == 0 && (ie->getSource().compare("Events_ReceiveFSM") != 0))
				{
			...
			try
			{
				if ((done == false) && ie->getName().compare("Timeout") == 0 && (ie->getSource().compare("Events_SendFSM") != 0))
				{
					Timeout* casted_ie = (Timeout*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("CommandCompleted") == 0 && (ie->getSource().compare("Events_SendFSM") != 0))
				{
					CommandCompleted* casted_ie = (CommandCompleted*) ie;
			...
			try
			{
				if ((done == false) && ie->getName().compare("CommandExpired") == 0 && (ie->getSource().compare("Events_SendFSM") != 0))
				{
					CommandExpired* casted_ie = (CommandExpired*) ie;
