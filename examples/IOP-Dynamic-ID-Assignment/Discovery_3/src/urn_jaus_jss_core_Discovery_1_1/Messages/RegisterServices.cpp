#include "urn_jaus_jss_core_Discovery_1_1/Messages/RegisterServices.h"

namespace urn_jaus_jss_core_Discovery_1_1
{

void RegisterServices::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void RegisterServices::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger RegisterServices::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int RegisterServices::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int RegisterServices::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void RegisterServices::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void RegisterServices::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
RegisterServices::MsgHeader::HeaderRec &RegisterServices::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool RegisterServices::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
RegisterServices::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x0b00;
}

RegisterServices::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
RegisterServices::MsgHeader::HeaderRec* const RegisterServices::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int RegisterServices::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void RegisterServices::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int RegisterServices::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void RegisterServices::MsgHeader::encode(unsigned char *bytes)
{
...
void RegisterServices::MsgHeader::decode(const unsigned char *bytes)
{
...
RegisterServices::MsgHeader &RegisterServices::MsgHeader::operator=(const MsgHeader &value)
{
...
bool RegisterServices::MsgHeader::operator==(const MsgHeader &value) const
{
...
RegisterServices::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

RegisterServices::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
RegisterServices::MsgHeader* const RegisterServices::getMsgHeader()
{
	return &m_MsgHeader;
}

int RegisterServices::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
