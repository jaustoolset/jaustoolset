#include "urn_jaus_jss_core_Discovery_1_1/Messages/QueryServices.h"

namespace urn_jaus_jss_core_Discovery_1_1
{

void QueryServices::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void QueryServices::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger QueryServices::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int QueryServices::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int QueryServices::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void QueryServices::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void QueryServices::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
QueryServices::MsgHeader::HeaderRec &QueryServices::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool QueryServices::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
QueryServices::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x2b03;
}

QueryServices::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
QueryServices::MsgHeader::HeaderRec* const QueryServices::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int QueryServices::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void QueryServices::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int QueryServices::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void QueryServices::MsgHeader::encode(unsigned char *bytes)
{
...
void QueryServices::MsgHeader::decode(const unsigned char *bytes)
{
...
QueryServices::MsgHeader &QueryServices::MsgHeader::operator=(const MsgHeader &value)
{
...
bool QueryServices::MsgHeader::operator==(const MsgHeader &value) const
{
...
QueryServices::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

QueryServices::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
QueryServices::MsgHeader* const QueryServices::getMsgHeader()
{
	return &m_MsgHeader;
}

int QueryServices::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
