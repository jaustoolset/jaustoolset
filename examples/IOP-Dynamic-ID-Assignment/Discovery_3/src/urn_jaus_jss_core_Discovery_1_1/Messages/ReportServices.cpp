#include "urn_jaus_jss_core_Discovery_1_1/Messages/ReportServices.h"

namespace urn_jaus_jss_core_Discovery_1_1
{

void ReportServices::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void ReportServices::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger ReportServices::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int ReportServices::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int ReportServices::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void ReportServices::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void ReportServices::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
ReportServices::MsgHeader::HeaderRec &ReportServices::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool ReportServices::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
ReportServices::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x4b03;
}

ReportServices::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
ReportServices::MsgHeader::HeaderRec* const ReportServices::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int ReportServices::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void ReportServices::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int ReportServices::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void ReportServices::MsgHeader::encode(unsigned char *bytes)
{
...
void ReportServices::MsgHeader::decode(const unsigned char *bytes)
{
...
ReportServices::MsgHeader &ReportServices::MsgHeader::operator=(const MsgHeader &value)
{
...
bool ReportServices::MsgHeader::operator==(const MsgHeader &value) const
{
...
ReportServices::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

ReportServices::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
ReportServices::MsgHeader* const ReportServices::getMsgHeader()
{
	return &m_MsgHeader;
}

int ReportServices::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
