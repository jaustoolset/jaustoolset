#include "urn_jaus_jss_core_Discovery_1_1/Messages/ReportConfiguration.h"

namespace urn_jaus_jss_core_Discovery_1_1
{

void ReportConfiguration::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void ReportConfiguration::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger ReportConfiguration::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int ReportConfiguration::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int ReportConfiguration::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void ReportConfiguration::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void ReportConfiguration::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
ReportConfiguration::MsgHeader::HeaderRec &ReportConfiguration::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool ReportConfiguration::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
ReportConfiguration::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x4b01;
}

ReportConfiguration::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
ReportConfiguration::MsgHeader::HeaderRec* const ReportConfiguration::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int ReportConfiguration::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void ReportConfiguration::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int ReportConfiguration::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void ReportConfiguration::MsgHeader::encode(unsigned char *bytes)
{
...
void ReportConfiguration::MsgHeader::decode(const unsigned char *bytes)
{
...
ReportConfiguration::MsgHeader &ReportConfiguration::MsgHeader::operator=(const MsgHeader &value)
{
...
bool ReportConfiguration::MsgHeader::operator==(const MsgHeader &value) const
{
...
ReportConfiguration::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

ReportConfiguration::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
ReportConfiguration::MsgHeader* const ReportConfiguration::getMsgHeader()
{
	return &m_MsgHeader;
}

int ReportConfiguration::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
