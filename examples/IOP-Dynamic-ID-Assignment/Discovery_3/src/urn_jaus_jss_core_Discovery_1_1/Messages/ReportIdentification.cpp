#include "urn_jaus_jss_core_Discovery_1_1/Messages/ReportIdentification.h"

namespace urn_jaus_jss_core_Discovery_1_1
{

void ReportIdentification::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void ReportIdentification::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger ReportIdentification::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int ReportIdentification::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int ReportIdentification::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void ReportIdentification::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void ReportIdentification::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
ReportIdentification::MsgHeader::HeaderRec &ReportIdentification::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool ReportIdentification::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
ReportIdentification::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x4b00;
}

ReportIdentification::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
ReportIdentification::MsgHeader::HeaderRec* const ReportIdentification::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int ReportIdentification::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void ReportIdentification::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int ReportIdentification::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void ReportIdentification::MsgHeader::encode(unsigned char *bytes)
{
...
void ReportIdentification::MsgHeader::decode(const unsigned char *bytes)
{
...
ReportIdentification::MsgHeader &ReportIdentification::MsgHeader::operator=(const MsgHeader &value)
{
...
bool ReportIdentification::MsgHeader::operator==(const MsgHeader &value) const
{
...
ReportIdentification::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

ReportIdentification::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
ReportIdentification::MsgHeader* const ReportIdentification::getMsgHeader()
{
	return &m_MsgHeader;
}

int ReportIdentification::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
