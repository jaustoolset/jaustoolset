#include "urn_jaus_jss_core_Discovery_1_1/Messages/ReportSubsystemList.h"

namespace urn_jaus_jss_core_Discovery_1_1
{

void ReportSubsystemList::MsgHeader::HeaderRec::setParent(MsgHeader* parent)
{
	m_parent = parent;
}

void ReportSubsystemList::MsgHeader::HeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger ReportSubsystemList::MsgHeader::HeaderRec::getMessageID()
{
	return m_MessageID;
}

int ReportSubsystemList::MsgHeader::HeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int ReportSubsystemList::MsgHeader::HeaderRec::getSize()
{
	unsigned int size = 0;
...
void ReportSubsystemList::MsgHeader::HeaderRec::encode(unsigned char *bytes)
{
...
void ReportSubsystemList::MsgHeader::HeaderRec::decode(const unsigned char *bytes)
{
...
ReportSubsystemList::MsgHeader::HeaderRec &ReportSubsystemList::MsgHeader::HeaderRec::operator=(const HeaderRec &value)
{
...
bool ReportSubsystemList::MsgHeader::HeaderRec::operator==(const HeaderRec &value) const
{
...
ReportSubsystemList::MsgHeader::HeaderRec::HeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x4b02;
}

ReportSubsystemList::MsgHeader::HeaderRec::HeaderRec(const HeaderRec &value)
{
...
ReportSubsystemList::MsgHeader::HeaderRec* const ReportSubsystemList::MsgHeader::getHeaderRec()
{
	return &m_HeaderRec;
}

int ReportSubsystemList::MsgHeader::setHeaderRec(const HeaderRec &value)
{
	m_HeaderRec = value;
	setParentPresenceVector();
	return 0;
...
void ReportSubsystemList::MsgHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int ReportSubsystemList::MsgHeader::getSize()
{
	unsigned int size = 0;
...
void ReportSubsystemList::MsgHeader::encode(unsigned char *bytes)
{
...
void ReportSubsystemList::MsgHeader::decode(const unsigned char *bytes)
{
...
ReportSubsystemList::MsgHeader &ReportSubsystemList::MsgHeader::operator=(const MsgHeader &value)
{
...
bool ReportSubsystemList::MsgHeader::operator==(const MsgHeader &value) const
{
...
ReportSubsystemList::MsgHeader::MsgHeader()
{
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
}

ReportSubsystemList::MsgHeader::MsgHeader(const MsgHeader &value)
{
	/// Initiliaze the protected variables
	m_HeaderRec.setParent(this);
	/// No Initialization of m_HeaderRec necessary.
...
ReportSubsystemList::MsgHeader* const ReportSubsystemList::getMsgHeader()
{
	return &m_MsgHeader;
}

int ReportSubsystemList::setMsgHeader(const MsgHeader &value)
{
	m_MsgHeader = value;
	return 0;
}
...
{
	if (m_SubsystemRec.size() !=  value.m_SubsystemRec.size())
	{
		return false;
	}
