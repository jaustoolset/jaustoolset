...
#if TRACE
                    Trace.WriteLine(
                        "ENTER TRANSITION: Transport_SendFSM_SM.Transport_SendFSM_SM.Sending.BroadcastGlobalTransition(, BroadcastGlobal msg)");
#endif
...
#if TRACE
                        Trace.WriteLine(
                            "EXIT TRANSITION : Transport_SendFSM_SM.Transport_SendFSM_SM.Sending.BroadcastGlobalTransition(, BroadcastGlobal msg)");
#endif
...
#if TRACE
                    Trace.WriteLine(
                        "ENTER TRANSITION: Transport_SendFSM_SM.Transport_SendFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastGlobalTransition()");
#endif

#if TRACE
                    Trace.WriteLine(
                        "EXIT TRANSITION : Transport_SendFSM_SM.Transport_SendFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastGlobalTransition()");
#endif
...
#if TRACE
                    Trace.WriteLine(
                        "ENTER TRANSITION: Transport_SendFSM_SM.Transport_SendFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastLocalTransition()");
#endif

#if TRACE
                    Trace.WriteLine(
                        "EXIT TRANSITION : Transport_SendFSM_SM.Transport_SendFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastLocalTransition()");
#endif
...
#if TRACE
                    Trace.WriteLine(
                        "ENTER TRANSITION: Transport_SendFSM_SM.Transport_SendFSM_SM.Internally_Generated_State_DO_NOT_USE.SendTransition()");
#endif

#if TRACE
                    Trace.WriteLine(
                        "EXIT TRANSITION : Transport_SendFSM_SM.Transport_SendFSM_SM.Internally_Generated_State_DO_NOT_USE.SendTransition()");
#endif
