...
#if TRACE
                    Trace.WriteLine(
                        "ENTER TRANSITION: Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastGlobalTransition()");
#endif

#if TRACE
                    Trace.WriteLine(
                        "EXIT TRANSITION : Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastGlobalTransition()");
#endif
...
#if TRACE
                    Trace.WriteLine(
                        "ENTER TRANSITION: Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastLocalTransition()");
#endif

#if TRACE
                    Trace.WriteLine(
                        "EXIT TRANSITION : Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.BroadcastLocalTransition()");
#endif
...
#if TRACE
                    Trace.WriteLine(
                        "ENTER TRANSITION: Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.SendTransition()");
#endif

#if TRACE
                    Trace.WriteLine(
                        "EXIT TRANSITION : Transport_ReceiveFSM_SM.Transport_ReceiveFSM_SM.Internally_Generated_State_DO_NOT_USE.SendTransition()");
#endif
