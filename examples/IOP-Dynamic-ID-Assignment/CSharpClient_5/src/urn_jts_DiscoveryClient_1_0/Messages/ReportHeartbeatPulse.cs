...
public class ReportHeartbeatPulse : JTS.Message
{
	protected ushort ID = 0x4202;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public ReportHeartbeatPulse.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public ReportHeartbeatPulse.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public ReportHeartbeatPulse.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public ReportHeartbeatPulse.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
	...
	public bool  isEqual(ReportHeartbeatPulse value)
	{
	...
	public bool  notEquals(ReportHeartbeatPulse value)
	{
		return !this.isEqual(value);
	}
