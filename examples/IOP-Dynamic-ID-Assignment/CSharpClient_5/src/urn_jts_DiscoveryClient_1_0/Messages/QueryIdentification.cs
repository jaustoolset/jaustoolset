...
public class QueryIdentification : JTS.Message
{
	protected ushort ID = 0x2b00;
	...
	public class MsgHeader
	{
		public class HeaderRec
		{
			...
			public QueryIdentification.MsgHeader.HeaderRec  setHeaderRec(HeaderRec value)
			{
		...
		public QueryIdentification.MsgHeader.HeaderRec getHeaderRec()
		{
			return m_HeaderRec;
		}
		...
		public QueryIdentification.MsgHeader  setMsgHeader(MsgHeader value)
		{
	...
	public class Body
	{
		public class QueryIdentificationRec
		{
		...
		public QueryIdentification.Body  setBody(Body value)
		{
		...
		{
			if (!this.getQueryIdentificationRec().isEqual(value.getQueryIdentificationRec()))
			{
				return false;
			}
			/// This code is currently not supported
		...
		protected QueryIdentificationRec m_QueryIdentificationRec = new  QueryIdentificationRec();
	}
	...
	public QueryIdentification.MsgHeader getMsgHeader()
	{
		return m_MsgHeader;
	}
