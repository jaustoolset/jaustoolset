...
inline urn_jaus_jss_core_MessageSet_QueryClass_QueryTimeout_Action_Send_ReportTimeout(sender_pid, incoming_pid){
	...
	urn_jaus_jss_core_MessageSet_InformClass_ReportTimeout rpt_timeout;
...
*/
inline urn_jaus_jss_core_MessageSet_QueryClass_QueryStatus_Action_Send_ReportStatus(sender_pid, incoming_pid){
	printf("executing action: urn_jaus_jss_core_MessageSet_QueryClass_QueryStatus_Action_Send_ReportStatus(sender_pid, incoming_pid);\n");
...
*  condition.
*/
inline urn_jaus_jss_core_MessageSet_CommandClass_SetEmergency_Action_StoreID(inputMessage){
 //Replace this print statement with a code line ending with a ;
// Ending a line with a back-slash allows the definiton to continue on the next line.
// This can be repeated as many times as necessary.  All 3 of these lines would make up the definition.
printf("executing action: urn_jaus_jss_core_MessageSet_CommandClass_SetEmergency_Action_StoreID(inputMessage);\n");
			service_status = EMERGENCY;
}
...
*  condition.
*/
inline urn_jaus_jss_core_MessageSet_CommandClass_ClearEmergency_Action_DeleteID(inputMessage){
 //Replace this print statement with a code line ending with a ;
// Ending a line with a back-slash allows the definiton to continue on the next line.
// This can be repeated as many times as necessary.  All 3 of these lines would make up the definition.
printf("executing action: urn_jaus_jss_core_MessageSet_CommandClass_ClearEmergency_Action_DeleteID(inputMessage);\n");
service_status = READY;
}
...
*/
inline urn_jaus_jss_core_MessageSet_CommandClass_Reset_Action_Send_RejectControl(sender_pid, param1, incoming_pid){
	printf("executing action: urn_jaus_jss_core_MessageSet_CommandClass_Reset_Action_Send_RejectControl(sender_pid, param1, incoming_pid);\n");
	urn_jaus_jss_core_MessageSet_CommandClass_RejectControl rej;
	rej.RejectControlRec.ResponseCode = param1;
	service_status = STANDBY;
...
*  Send a Reject Control message to the client that is currently controlling this service.
*/
inline urn_jaus_jss_core_MessageSet_CommandClass_Shutdown_Action_Send_RejectControl(sender_pid, param1, incoming_pid){
	printf("executing action: urn_jaus_jss_core_MessageSet_CommandClass_Shutdown_Action_Send_RejectControl(sender_pid, param1, incoming_pid);\n");
	urn_jaus_jss_core_MessageSet_CommandClass_RejectControl rej;
	rej.RejectControlRec.ResponseCode = param1;
	service_status = STANDBY;
	RejectControl[incoming_pid] ! sender_pid, rej;
