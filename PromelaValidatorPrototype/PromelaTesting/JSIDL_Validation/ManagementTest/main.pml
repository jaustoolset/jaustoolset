/** 
 *  This Promela file was auto-generated using JTS on Wed May 18 12:47:37 EDT 2011.
...
active proctype ReceiveFSM(){
	...
	urn_jaus_jss_core_MessageSet_CommandClass_SetEmergency urn_jaus_jss_core_MessageSet_CommandClass_SetEmergency_inst;
	//  enveloped set emergency message
	//  enveloped release control message
	urn_jaus_jss_core_MessageSet_CommandClass_Shutdown urn_jaus_jss_core_MessageSet_CommandClass_Shutdown_inst;
	urn_jaus_jss_core_MessageSet_QueryClass_QueryStatus urn_jaus_jss_core_MessageSet_QueryClass_QueryStatus_inst;
	urn_jaus_jss_core_MessageSet_QueryClass_QueryAuthority urn_jaus_jss_core_MessageSet_QueryClass_QueryAuthority_inst;
	urn_jaus_jss_core_MessageSet_CommandClass_Standby urn_jaus_jss_core_MessageSet_CommandClass_Standby_inst;
	urn_jaus_jss_core_MessageSet_CommandClass_RequestControl urn_jaus_jss_core_MessageSet_CommandClass_RequestControl_inst;
	urn_jaus_jss_core_MessageSet_CommandClass_Resume urn_jaus_jss_core_MessageSet_CommandClass_Resume_inst;
	//  enveloped standby message
	urn_jaus_jss_core_MessageSet_CommandClass_ClearEmergency urn_jaus_jss_core_MessageSet_CommandClass_ClearEmergency_inst;
	...
	urn_jaus_jss_core_MessageSet_CommandClass_Reset urn_jaus_jss_core_MessageSet_CommandClass_Reset_inst;
			...
			do
				...
				do
					...
					do
						...
						:: QueryStatus ? incoming_pid, urn_jaus_jss_core_MessageSet_QueryClass_QueryStatus_inst ->
							if
							// unguarded transition 
							:: true ->
								//  Send a Report Status message with the current status
								urn_jaus_jss_core_MessageSet_QueryClass_QueryStatus_Action_Send_ReportStatus(_pid, incoming_pid);
							fi
							
						:: SetEmergency ? incoming_pid, urn_jaus_jss_core_MessageSet_CommandClass_SetEmergency_inst ->
							if
							// unguarded transition 
							:: true ->
								//  Add the sender of the message that caused this action to the list of clients that have an emergency
								//  condition.
								urn_jaus_jss_core_MessageSet_CommandClass_SetEmergency_Action_StoreID(urn_jaus_jss_core_MessageSet_CommandClass_SetEmergency_inst);
				...
				do
					...
					do
						...
						:: ClearEmergency ? incoming_pid, urn_jaus_jss_core_MessageSet_CommandClass_ClearEmergency_inst ->
							if
							/**
							...
							*/
							::  isIDStored( incoming_pid ) ->
								...
								//  condition.
								urn_jaus_jss_core_MessageSet_CommandClass_ClearEmergency_Action_DeleteID(urn_jaus_jss_core_MessageSet_CommandClass_ClearEmergency_inst);
						...
						:: Shutdown ? incoming_pid, urn_jaus_jss_core_MessageSet_CommandClass_Shutdown_inst ->
							if
							// unguarded transition 
							:: true ->
							fi
							
						:: Reset ? incoming_pid, urn_jaus_jss_core_MessageSet_CommandClass_Reset_inst ->
							if
							// unguarded transition 
							:: true ->
							fi
			...
			do
				...
				do
					...
					do
						...
						:: Resume ? incoming_pid, urn_jaus_jss_core_MessageSet_CommandClass_Resume_inst ->
							if
							/**
							*  True if the message that triggered the transition is received from the client that is in control of
							*  this service
						...
						:: Reset ? incoming_pid, urn_jaus_jss_core_MessageSet_CommandClass_Reset_inst ->
							...
							*/
							::  isControllingClient( incoming_pid ) ->
								...
								urn_jaus_jss_core_MessageSet_CommandClass_Reset_Action_Send_RejectControl(_pid, CONTROL_RELEASED, incoming_pid);
						...
						:: Shutdown ? incoming_pid, urn_jaus_jss_core_MessageSet_CommandClass_Shutdown_inst ->
							...
							*/
							::  isControllingClient( incoming_pid ) ->
								//  Send a Reject Control message to the client that is currently controlling this service.
								urn_jaus_jss_core_MessageSet_CommandClass_Shutdown_Action_Send_RejectControl(_pid, CONTROL_RELEASED, incoming_pid);
					...
					do
						...
						:: Standby ? incoming_pid, urn_jaus_jss_core_MessageSet_CommandClass_Standby_inst ->
							if
							/**
							*  True if the message that triggered the transition is received from the client that is in control of
							*  this service
