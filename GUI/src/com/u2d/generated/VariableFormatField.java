...
@Entity
public  class VariableFormatField extends SimpleField {

    
    /** Creates a new instance of VariableFormatField */
    public VariableFormatField() {
    }
    public Title title() { 
        StringBuffer text = new StringBuffer();
        text.append(name.title() + " [VariableFormatField]");
    ...
    public void setFormatField(FormatField formatField) {
        FormatField old = this.formatField;
        this.formatField = formatField;
        firePropertyChange("formatField", old, this.formatField );
    }
 
/************** Uncomment the following as needed *****************************/
      public static String[] fieldOrder  = {"name", "optional", "minSize", "maxSize", "formatField", "interpretation", "referencingElements"};
...
//    public static String pluralName() { return "VariableFormatFields"; }
...
//    {
//       return new CustomVariableFormatFieldView(this);
//    }
/**********************/
/**@Cmd place holder**/        
}
