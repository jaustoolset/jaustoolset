...
@Entity
public  class ValueRange extends AbstractComplexEObject_JTS{
    ...
    public Title title() { 
        ...
        text.append(name.title() + " [ValueRange]");
    ...
    // ******    lowerLimit   ******
    private final StringEO lowerLimit = new StringEO();
    public StringEO getLowerLimit() { return lowerLimit;}

    // ******    upperLimit   ******
    private final StringEO upperLimit = new StringEO();
...
/************** Uncomment the following as needed *****************************/
      public static String[] fieldOrder  = {"name", "lowerLimit", "upperLimit", "interpretation", "referencingValueSet"};
...
//    public static String pluralName() { return "ValueRanges"; }
...
//    {
//       return new CustomValueRangeView(this);
//    }
/**********************/
/**@Cmd place holder**/        
}
