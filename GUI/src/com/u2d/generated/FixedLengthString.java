...
@Entity
public  class FixedLengthString extends SimpleField {

    
    /** Creates a new instance of FixedLengthString */
    public FixedLengthString() {
    }
    public Title title() { 
        StringBuffer text = new StringBuffer();
        text.append(name.title() + " [FixedLengthString]");
    ...
    // ******    stringLength   ******
    private final IntEO stringLength = new IntEO();
...
/************** Uncomment the following as needed *****************************/
      public static String[] fieldOrder  = {"name", "optional", "stringLength",     "interpretation", "referencingElements"};
...
//    public static String pluralName() { return "FixedLengthStrings"; }
...
//    {
//       return new CustomFixedLengthStringView(this);
//    }
/**********************/
/**@Cmd place holder**/        
}
