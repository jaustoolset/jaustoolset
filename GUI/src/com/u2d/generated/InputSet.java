...
@Entity
public  class InputSet extends AbstractComplexEObject_JTS{

    
    /** Creates a new instance of InputSet */
    public InputSet() {
    }
    public Title title() { 
        StringBuffer text = new StringBuffer();
        text.append(name.title() + " [InputSet]");
...
//    public static String pluralName() { return "InputSets"; }
...
//    {
//       return new CustomInputSetView(this);
//    }
/**********************/
/**@Cmd place holder**/        
}
