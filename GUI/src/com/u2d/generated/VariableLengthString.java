...
@Entity
public  class VariableLengthString extends SimpleField {

    
    /** Creates a new instance of VariableLengthString */
    public VariableLengthString() {
    }
    public Title title() { 
        StringBuffer text = new StringBuffer();
        text.append(name.title() + " [VariableLengthString]");
    ...
    // ******    minLength   ******
    private final LongEO minLength = new LongEO();
    public LongEO getMinLength() { return minLength;}

    // ******    maxLength   ******
    private final LongEO maxLength = new LongEO();
...
/************** Uncomment the following as needed *****************************/
      public static String[] fieldOrder  = {"name", "optional", "minLength", "maxLength",      "interpretation", "referencingElements"};
...
//    public static String pluralName() { return "VariableLengthStrings"; }
...
//    {
//       return new CustomVariableLengthStringView(this);
//    }
/**********************/
/**@Cmd place holder**/        
}
