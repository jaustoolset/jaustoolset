...
@Entity
public  class ValueEnum extends AbstractComplexEObject_JTS{

    
    /** Creates a new instance of ValueEnum */
    public ValueEnum() {
    }
    public Title title() { 
        StringBuffer text = new StringBuffer();
        text.append(name.title() + " [ValueEnum]");
    ...
    // ******    enumIndex   ******
    private final IntEO enumIndex = new IntEO();
    public IntEO getEnumIndex() { return enumIndex;}

    // ******    enumConstant   ******
    private final StringEO enumConstant = new StringEO();
...
/************** Uncomment the following as needed *****************************/
      public static String[] fieldOrder  = {"name", "enumIndex", "enumConstant", "interpretation", "referencingValueSet"};
...
//    public static String pluralName() { return "ValueEnums"; }
...
//    {
//       return new CustomValueEnumView(this);
//    }
/**********************/
/**@Cmd place holder**/        
}
