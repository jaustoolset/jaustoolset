...
@Entity
public  class Variant extends ComplexField {

    
    /** Creates a new instance of Variant */
    public Variant() {
    }
    public Title title() { 
        StringBuffer text = new StringBuffer();
        text.append(name.title() + " [Variant]");
...
//    public static String pluralName() { return "Variants"; }
...
//    {
//       return new CustomVariantView(this);
//    }
/**********************/
/**@Cmd place holder**/        
}
