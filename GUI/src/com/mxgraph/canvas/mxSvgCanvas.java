/**
 * $Id: mxSvgCanvas.java,v 1.41 2009/02/15 10:01:06 gaudenz Exp $
...
public class mxSvgCanvas extends mxBasicCanvas
{
	 ...
	 * 
	 * @param width Width of the canvas to be constructed.
	 * @param height Height of the canvas to be constructed.
	 * @param scale Scale of the canvas to be constructed.
	 */
	public mxSvgCanvas()
	{
		this(null);
	 ...
	 * background color.
	 * 
	 * @param x X-coordinate of the origin of the canvas.
	 * @param y Y-coordinate of the origin of the canvas.
	 * @param width Width of the canvas to be constructed.
	 * @param height Height of the canvas to be constructed.
	 * @param scale Scale of the canvas to be constructed.
	 * @param backgroundColor Color of the background. Default is null
	 * (transparent).
	 */
	...
	public Element drawShape(int x, int y, int w, int h, Hashtable style)
	{
		...
		if (shape.equals(mxConstants.SHAPE_IMAGE))
		{
			...
			if (img != null)
			{
				...
				// TODO: Add global namespace shortcut in document
				elem.setAttributeNS(mxConstants.NS_XLINK, "href", img);
			}
		}
