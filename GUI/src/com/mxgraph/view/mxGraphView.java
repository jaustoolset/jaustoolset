/**
 * $Id: mxGraphView.java,v 1.117 2009/03/02 15:12:06 gaudenz Exp $
...
public class mxGraphView extends mxEventSource
{
	 ...
	 * 
	 */
	public static String EVENT_UP = "up";

	/**
	 * 
	 */
	public static String EVENT_DOWN = "down";

	/**
	 * 
	 */
	public static String EVENT_SCALE = "scale";

	/**
	 * 
	 */
	public static String EVENT_TRANSLATE = "translate";

	/**
	 * 
	 */
	public static String EVENT_SCALE_AND_TRANSLATE = "scaleAndTranslate";
	 ...
	 */
	protected mxRectangle bounds = new mxRectangle();
	...
	public void scaleAndTranslate(double scale, double dx, double dy)
	{
		...
		fireEvent(EVENT_SCALE_AND_TRANSLATE, new Object[] { oldScale, scale,
	...
	public void setScale(double value)
	{
		...
		fireEvent(EVENT_SCALE, new Object[] { old, scale });
	}
	...
	public void setTranslate(mxPoint value)
	{
		...
		fireEvent(EVENT_TRANSLATE, new Object[] { old, translate });
	}
	...
	public mxRectangle getBounds(Object[] cells, boolean boundingBox)
	{
		...
		if (cells != null && cells.length > 0)
		{
			for (int i = 0; i < cells.length; i++)
			{
				...
				if (state != null)
				{
					mxRectangle tmp = (boundingBox) ? state.getBoundingBox()
							: state;
	...
	public void validate()
	{
		...
		if (cell != null)
		{
			...
			bounds = validatePoints(null, cell);
		}
	}
	...
	public void updateLabelBounds(mxCellState state)
	{
		...
		String label = graph.getAbbreviation( graph.getLabel(cell), ((com.mxgraph.model.mxCell)cell).getStyle() );
		// jts

		mxRectangle size = mxUtils.getLabelSize(label, style, graph
				.isHtmlLabel(cell));
		...
		if (!graph.getModel().isEdge(cell))
		{
			...
			double start = mxUtils
					.getDouble(style, mxConstants.STYLE_STARTSIZE)
					* scale;
			...
			else if (points != null)
			{
				for (int i = 0; i < points.size(); i++)
				{
					...
					if (tmp instanceof mxPoint)
					{
						...
						pts.add(transformControlPoint(pt, state.getOrigin()));
					}
				}
			}
	 ...
	 */
	public mxPoint transformControlPoint(mxPoint pt, mxPoint origin)
	{
	 ...
	 */
	public mxCellState[] getStates(Object[] cells)
	{
	...
	public static class mxCurrentRootChange implements mxUndoableChange
	{
		...
		public void execute()
		{
			...
			String eventName = (up) ? EVENT_UP : EVENT_DOWN;
			view.fireEvent(eventName,
					new Object[] { previous, view.currentRoot });
		}
