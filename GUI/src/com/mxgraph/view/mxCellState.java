/**
 * $Id: mxCellState.java,v 1.28 2009/01/24 11:17:47 gaudenz Exp $
...
public class mxCellState extends mxRectangle
{
	 ...
	 */
	public mxCellState(mxGraphView view, Object cell, Hashtable style)
	{
		setView(view);
		setCell(cell);
		setStyle(style);
	 ...
	 */
	public void setStyle(Hashtable style)
	{
		this.style = style;
	}
	...
	{
		return (mxPoint) absolutePoints.get(index);
	}
	...
	{
		return (mxPoint) absolutePoints.set(index, point);
	}
