/**
 * $Id: mxIGraphModel.java,v 1.22 2009/03/05 14:30:40 gaudenz Exp $
...
public interface mxIGraphModel
{
	 ...
	 * <code>
	 * addListener(
	 *   mxIGraphModel.EVENT_CHANGE, new mxEventListener()
	 *   {
	 ...
	 * </code>
	 */
	static String EVENT_CHANGE = "change";
	 ...
	 */
	static String EVENT_BEFORE_EXECUTE = "beforeExecute";
	 ...
	 */
	static String EVENT_EXECUTE = "execute";
	 ...
	 */
	static String EVENT_AFTER_EXECUTE = "afterExecute";
	 ...
	 * the model.
	 */
	static String EVENT_BEFORE_UNDO = "beforeUndo";

	/**
	 * Holds the name for the undo event. First and only argument in the
	 * argument array is the current edit that is currently in progress in the 
	 * model. This event fires after notify has been called on the currentEdit in
	 * the model, it fires only once per undoable edit.
	 */
	static String EVENT_UNDO = "undo";
	 ...
	 */
	static String EVENT_NOTIFY = "notify";
	 ...
	 */
	static String EVENT_BEGIN_UPDATE = "beginUpdate";
	 ...
	 * currentEdit.
	 */
	static String EVENT_END_UPDATE = "endUpdate";
	 ...
	 * @param isCollapsed Boolean that specifies the new collpased state.
	 ...
	 * @param isVisible Boolean that specifies the new visible state.
