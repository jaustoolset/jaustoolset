/**
 * $Id: mxCell.java,v 1.23 2009/02/26 12:12:54 gaudenz Exp $
...
public class mxCell implements mxICell, Cloneable, Serializable
{
	 ...
	 */
	protected transient List children, edges;
	 ...
	 */
	 //jts
	 // the red color #BC1212 used for inherited information is used to enforce read-only functionality
	...
	public void setValue(Object value)
	{
		...
		if( ! readonly )
	      ...
	      if( style != null && style.contains("#BC1212") ) {
	        readonly = true;
	      }
	      //JTS
	}
	...
	public void setStyle(String style)
	{
		...
		// JTS  (this code helps when double click is used on transitions to flip their orientations)
		//this.style = style;
		if( this.style == null || this.style.length() == 0 )
		  this.style = style;
		else if( this.style.startsWith("finiteStateMachine") ) 
		  this.style = "finiteStateMachine;" + style;
		else if( this.style.startsWith("pseudoStartState") ) 
		  this.style = "pseudoStartState;" + style;
		else if( this.style.startsWith("state") ) 
		  this.style = "state;" + style;
		else if( this.style.startsWith("defaultState") ) 
		  this.style = "defaultState;" + style;
		else if( this.style.startsWith("internalTransition") ) 
		  this.style = "internalTransition;" + style;  
	      else if( this.style.startsWith("simpleTransition") ) 
		  this.style = "simpleTransition;" + style;
	      else if( this.style.startsWith("pushTransition") ) 
		  this.style = "pushTransition;" + style;
	      else if( this.style.startsWith("popTransition") ) 
		  this.style = "popTransition;" + style;
		else if( this.style.startsWith("defaultInternalTransition") ) 
		  this.style = "defaultInternalTransition;" + style;  
	      else if( this.style.startsWith("defaultSimpleTransition") ) 
		  this.style = "defaultSimpleTransition;" + style;
	      else if( this.style.startsWith("defaultPushTransition") ) 
		  this.style = "defaultPushTransition;" + style;
		else if( this.style.startsWith("defaultPopTransition") ) 
		  this.style = "defaultPopTransition;" + style;
		else 
		  this.style = style;	
		// jts
	}
	...
	public Object clone()
	{
		mxCell clone = new mxCell(cloneValue(), null, getStyle());
	...
	public String getToolTip() {
	  String tip = "<html>";
	  		...
	  		// the style of the cell may be initialized to null
	  		if(style == null)
	  		{
	  			return  tip += "</html>";
	  		}

// [tbd] the line below throws a null pointer exceptions sometimes during a mouse over at 45% zoom
			if( style.startsWith("finiteStateMachine") ) {
                tip+= "Usage: name=<i>name</i>; isStateless=<i>true OR false</i>";
            }
			else if( style.startsWith("pseudoStartState") ) {
                    tip+= "Usage: ";

            }
            else if( style.startsWith("state") ){
                    tip+= "Usage: <b>name</b>; <b>entry<i>(OR exit)</i></b>:<b>action1</b>(<b>arg1</b>,...);...";
            }
            else if( style.startsWith("defaultState") ){
                    tip+= "Usage: ";
            }
            else if( style.startsWith("internalTransition") ){
                    tip+= "Usage: <b><u>trigger</u></b>(<b>paramType</b> value, ...)[guard]/<b>action</b>(<b>arg1</b>,...),...;...";
            }
            else if( style.startsWith("simpleTransition") ){
                    tip+= "Usage: <b><u>trigger</u></b>(<b>paramType</b> value, ...)[guard]/<b>action</b>(<b>arg1</b>,...),...;...";
            }
            else if( style.startsWith("pushTransition") ){
                    tip+= "Usage: <b><u>trigger</u></b>(<b>paramType</b> value, ...)[guard]/<b>action</b>(<b>arg1</b>,...),...{<b>end_state</b>};...";
            }
            else if( style.startsWith("popTransition") ){
                    tip+= "Usage: <b><u>trigger</u></b>(<b>paramType</b> value, ...)[guard]/<b>action</b>(<b>arg1</b>,...),...{<b>end_transition</b>(<b>arg1</b>,...};...";
            }
            else if( style.startsWith("defaultInternalTransition") ){
                    tip+= "Usage: [guard]/<b>action</b>(<b>arg1</b>,...),...;...";
            }
            else if( style.startsWith("defaultSimpleTransition") ){
                    tip+= "Usage: [guard]/<b>action</b>(<b>arg1</b>,...),...;...";
            }
            else if( style.startsWith("defaultPushTransition") ){
                    tip+= "Usage: [guard]/<b>action</b>(<b>arg1</b>,...),...{<b>end_state</b>};...";
            }
            else if( style.startsWith("defaultPopTransition") ){
                    tip+= "Usage: [guard]/<b>action</b>(<b>arg1</b>,...),...{<b>end_transition</b>(<b>arg1</b>,...};...";
            }
