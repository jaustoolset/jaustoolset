...
public class ActionSet extends ExtendableSet< org.jts.jsidl.binding.Action, ActionNode >
{

	public ActionSet( DefaultMutableTreeNode parent )
	{
		super( "Actions", parent );
	}
