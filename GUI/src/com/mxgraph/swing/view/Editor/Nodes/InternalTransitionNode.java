...
public class InternalTransitionNode extends TransitionNode
{
	public InternalTransitionNode( DefaultMutableTreeNode parent )
	{		
	...
	public org.jts.jsidl.binding.Transition convertTo()
	{
		...
		// type
		org.jts.jsidl.binding.Internal tr = new org.jts.jsidl.binding.Internal();
		output.setInternal( tr );
