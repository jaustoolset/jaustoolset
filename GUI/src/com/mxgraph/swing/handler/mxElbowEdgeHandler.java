/**
 * $Id: mxElbowEdgeHandler.java,v 1.6 2009/03/02 14:25:38 gaudenz Exp $
...
public class mxElbowEdgeHandler extends mxEdgeHandler
{
	...
	protected Rectangle[] createHandles()
	{
		...
		else
		{
			...
			pt = view.transformControlPoint((mxPoint) points.get(0),
					state.getOrigin()).getPoint();
		}
		...
		{
			h[1] = createHandle(pt, mxConstants.HANDLE_SIZE + 1);
		}
