/*
 * $Id: JTableRenderer.java,v 1.4 2009/03/05 15:39:44 gaudenz Exp $
...
public class JTableRenderer extends JComponent
{
	 ...
	 * 
	 */
	public static final String IMAGE_PATH = "/com/mxgraph/swing/examples/images/";
	...
	public class ResizeHandler implements MouseListener, MouseMotionListener
	{
		...
		public void mousePressed(MouseEvent e)
		{
			...
			mxCellHandler handler = graphContainer.getGraphHandler()
					.getHandler(cell);
