/* 
 * $Id: EditorRuler.java,v 1.3 2009/01/14 14:39:55 gaudenz Exp $
		...
		DropTargetListener
{
	...
	public EditorRuler(mxGraphComponent graphComponent, int orientation)
	{
		...
		graphComponent.getGraph().getView().addListener(
				mxGraphView.EVENT_SCALE, repaintHandler);
		graphComponent.getGraph().getView().addListener(
				mxGraphView.EVENT_TRANSLATE, repaintHandler);
		graphComponent.getGraph().getView().addListener(
				mxGraphView.EVENT_SCALE_AND_TRANSLATE, repaintHandler);
