...
public class EditorPalette extends JPanel
{
	 ...
	 * 
	 */
	protected Color gradientColor = new Color(174, 197, 219);
	...
	{
		setBackground(new Color(174, 197, 219));
	...
	public void addTemplate(final String name, ImageIcon icon, mxCell cell)
	{
		...
		final JLabel entry = new JLabel(icon)
		{
			...
			public void paint2(Graphics g)
			{
				...
				{
					setBackground(EditorPalette.this.getBackground().brighter());
		...
		entry.setToolTipText( cell.getToolTip() );
		entry.setText(name);
