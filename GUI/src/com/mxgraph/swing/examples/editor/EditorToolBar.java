...
// JTS
import com.mxgraph.swing.examples.editor.EditorActions.ValidateAction;
import com.mxgraph.swing.examples.editor.EditorActions.SaveDefinitionAction;
...
public class EditorToolBar extends JToolBar
{
	...
	public EditorToolBar(final BasicGraphEditor editor, int orientation)
	{
		...
		// JTS
		JButton validateButton = add(editor.bind("Validate", new ValidateAction(),
				"/com/mxgraph/swing/examples/images/validate.gif"));
		validateButton.setToolTipText("Validate Selection");
		
		JButton saveDefinitionButton = add(editor.bind("Save Definitions", new SaveDefinitionAction(),
				"/com/mxgraph/swing/examples/images/saveDef.gif"));
		saveDefinitionButton.setToolTipText("Save Definition");
