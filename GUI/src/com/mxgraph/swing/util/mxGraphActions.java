/**
 * $Id: mxGraphActions.java,v 1.9 2009/03/06 13:12:59 gaudenz Exp $
...
public class mxGraphActions
{
	...
	public static class GroupAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if (graph != null)
			{
				graph.groupCells(null, 2 * graph.getGridSize());
			}
		}
	...
	public static class LayerAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			if (graph != null)
			{
				if (getValue(Action.NAME).toString().equalsIgnoreCase("toBack"))
				{
					graph.cellsToBack();
				}
				else
